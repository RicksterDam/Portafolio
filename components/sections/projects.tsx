      ...
      <div className="relative overflow-hidden h-full flex flex-col justify-between">
        ...
        <AnimatePresence mode="wait">
          ...
          <motion.div
            ...
            className="w-full min-h-[435px] rounded-3xl border border-white/10 bg-white/[0.03] p-8 md:p-10 hover:bg-white/[0.05] hover:border-white/20 transition-all duration-300"
          >
